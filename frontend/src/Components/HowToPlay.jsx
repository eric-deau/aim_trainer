        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4">
                ...
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
                    ...
                    <p className="mt-1 text-sm text-zinc-600 dark:text-zinc-300">
                        Your score is based on hits (and optionally accuracy, depending on your mode).
                    </p>
                </div>
                ...
                <div className="rounded-2xl border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
                    <h3 className="font-semibold text-zinc-900 dark:text-white">Tips</h3>
                    <ul className="mt-1 list-disc pl-5 text-sm text-zinc-600 dark:text-zinc-300 space-y-1">
                        <li>Focus on smooth movement, not speed</li>
                        <li>Try to keep accuracy high</li>
                        <li>Warm up with a few runs</li>
                    </ul>
                </div>
            </div>
        </div>
